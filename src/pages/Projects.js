    ...
    <div>
      ...
      <div className="projectsListContainer">
        ...
        <a href='https://devpost.com/software/licensequest' target="_blank">
          <div class="card">
            <img src={LicenseQuest} alt="" className="w-1/2 bg-offWhite rounded-2xl" />
            <div class="card__content">
              <p class="card__title">Hackathon Project</p>
              <p class="card__description">A mobile app created using React-Native and Expo.
                Our backend utilizes API calls to Inrix's custom traffic API(s) and Amazon's AWS.
                I personally worked on the Front End, using Figma to plan designs and implementing them.
                In addition, I programmed the app's navigation stack in addition to our written test-prep feature.</p>
            </div>
          </div>
        </a>
      ...
      <div className="projectsListContainer">
        ...
        <a href='https://ieeexplore.ieee.org/document/9615809/' target="_blank">
          <div class="card">
            <img src={Bronco} alt="" className="w-5/6 bg-offWhite rounded-2xl" />
            <div class="card__content">
              <p class="card__title">Research Project</p>
              <p class="card__description">Worked alongside Dr. Navid Shaghaghi and a few of my fellow peers to
              ...
              functionality for certain screens and "modernized" the UI.</p>
            </div>
          </div>
        </a>
      ...
      <div className="projectsListContainer">
        ...
        <a href='https://devpost.com/software/hi-9cjrfo' target="_blank">
          <div class="card">
            <img src={Allescan} alt="" className=" w-5/6 bg-offWhite rounded-2xl" />
            <div class="card__content">
              <p class="card__title">Hackathon Project</p>
              <p class="card__description">AlleScan was my first Hackathon Project. I teamed up with five others
...
system for authentication using Firebase.</p>
            </div>
          </div>
        </a>
        <div className="flex flex-row flex-wrap justify-center">
